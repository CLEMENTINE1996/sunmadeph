                            ...
                            >
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        {role.is_new && (
                                            <span className="px-2 py-0.5 font-bold rounded-full text-dark dark:text-light">New</span>
                                        )}
                                    </div>
                                        ...
                                        <div className="p-6 pb-8 pt-2 border-t border-dark/5 dark:border-light/5">
                                            <div className="grid md:grid-cols-1 gap-8">
                                                <div className="md:col-span-2">
                                                    <h3 className="text-dark dark:text-light font-bold uppercase tracking-wider  mb-3">Description</h3>
                                                    <p className="text-dark dark:text-light leading-relaxed mb-6">
                                                        {role.description}
                                                    </p>
                                                    <h3 className="text-dark dark:text-light font-bold uppercase tracking-wider  mb-3">Qualifications</h3>
                                                    <ul className="text-dark dark:text-light grid grid-cols-1 sm:grid-cols-1 gap-2 mb-6">
                                                    ...
                                                    <h3 className="text-dark dark:text-light font-bold uppercase tracking-wider  mb-3">Job Details</h3>
                                                    <ul className="text-dark dark:text-light grid grid-cols-1 sm:grid-cols-1 gap-2 mb-6">
                                                    ...
                                                    <h3 className="text-dark dark:text-light font-bold uppercase tracking-wider  mb-3">Key Requirements</h3>
                                                    <ul className="text-dark dark:text-light grid grid-cols-1 sm:grid-cols-1 gap-2">
